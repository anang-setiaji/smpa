                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <select name="maintenance" onchange="yesnoCheck(this);">
                            <option {{$request->maintenance === 'MAINTENANCE' ? 'selected' : ''}} value="MAINTENANCE">MAINTENANCE</option>
                            <option {{$request->maintenance === 'ACTIVE' ? 'selected' : ''}} value="ACTIVE">ACTIVE</option>
                            <option {{$request->maintenance === 'NOT ACTIVE' ? 'selected' : ''}} value="NOT ACTIVE">NOT ACTIVE</option>
                            <option {{$request->maintenance === 'ON PROGRESS' ? 'selected' : ''}} value="ON PROGRESS">ON PROGRESS</option>
                          </select>
