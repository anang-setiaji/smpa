...
<head>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <link rel="stylesheet"
        href="https://rawcdn.githack.com/anang-setiaji/smpa/dec02092223f537e9b5100fed42309e3c1dbdcbc/style.css">
            ...
            <nav id="sidebar">
              ...
              <li>
                  <a href="#">boleh</a>
                    ...
                    <li>
                        <a href="/chat"><i class="fa fa-comments" style="font-size:24px;color:white;opacity:0.5;"></i>
                            Chat
                ...
                <li>
                    ...
                    @if (count(auth()->user()->unreadNotifications) != 0)
                        <li onclick="markNotificationAsRead({{ count(auth()->user()->unreadNotifications) }})">
                            <a href="/requesta"><i class="fa fa-laptop"
                                    style="font-size:24px;color:white;opacity:0.5;"></i> Daftar Pengajuan <span
                                    class="badge" style="background-color:red;font-size:16px;margin-left:7px">
                                    {{ count(auth()->user()->unreadNotifications) }}</span> </a>
                        </li>
                    @else
                        <li>
                            <a href="/requesta"><i class="fa fa-laptop"
                                    style="font-size:24px;color:white;opacity:0.5;"></i> Daftar Pengajuan </a>
                        </li>
                    @endif
                    <li>
                        <a href="/aplikasi"><i class="fa fa-cogs" style="font-size:24px;color:white;opacity:0.5;"></i>
                            Daftar Aplikasi</a>
                    </li>

                    <li>
                        <a href="/daftarskpd"><i class="fa fa-building"
                                style="font-size:24px;color:white;opacity:0.5;"></i> SKPD</a>
                    </li>
                    <li>
                        <a href="/admin"><i class="fa fa-user" style="font-size:24px;color:white;opacity:0.5;"></i>
                            Admin</a>
                    </li>
                    <li>
                        <a href="/chats"><i class="fa fa-comments" style="font-size:24px;color:white;opacity:0.5;"></i>
                            Chat</a>
                    </li>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control"
                                            name="aplikasi">{{ $request->aplikasi }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select name="maintenance" onchange="yesnoCheck(this);">
                                            <option {{ $request->maintenance === 'MAINTENANCE' ? 'selected' : '' }}
                                                value="MAINTENANCE" style="pointer-events:none">MAINTENANCE</option>
                                            <option {{ $request->maintenance === 'ACTIVE' ? 'selected' : '' }}
                                                value="ACTIVE" style="pointer-events:none">ACTIVE</option>
                                            <option {{ $request->maintenance === 'NOT ACTIVE' ? 'selected' : '' }}
                                                value="NOT ACTIVE" style="pointer-events:none">NOT ACTIVE</option>
                                            <option {{ $request->maintenance === 'ON PROGRESS' ? 'selected' : '' }}
                                                value="ON PROGRESS" style="pointer-events:none">ON PROGRESS</option>
                                        </select>
                          ...
                          <span class="checkmark"></span>
                                ...
                                <div id="ifYes" style="display: none;">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control"
                                                name="alasan">{{ $request->alasan }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" type="date"
                                                name="kapan">{{ $request->kapan }}</input>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-10"> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <label for="actual-btn" style="background-color:#337ab7;
                            color: white;
                            padding: 0.7rem;
                            ...
                            font-family: sans-serif;">
                                                <input type="hidden" name="logo" class="form-control"
                                                    value="{{ $request->logo }}">{{ $request->logo }} </input>
                                                <img style="width:50px"
                                                    src="{{ url('uploads') }}/{{ $request->logo }}">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="clone hide">
                                                <div class="hdtuto control-group lst input-group"
                                                    ...
                                                    <input type="file" name="filenames[]" class="myfrm form-control">
                                                    <div class="input-group-btn">
                                                        <button class="remove-btn btn btn-danger" type="button"><i
                                    ...
                                    @foreach ($pictures as $picture)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="hidden" name="fileExists[]" value="{{ $picture }}" />
                                                <button id="remove" class="remove-exists btn btn-danger "
                                                    type="button"><i
                                                        class="fldemo glyphicon glyphicon-remove"></i></button>
                                            </div>
                                        </div>
                                    @endforeach
                                @else
                                        ...
                                        <div class="col-sm-10">
                                            <div class="clone hide">
                                                <div class="hdtuto control-group lst input-group"
                                                    ...
                                                    <input type="file" name="filenames[]" class="myfrm form-control">
                                                    <div class="input-group-btn">
                                                        <button id="remove" class="btn btn-danger" type="button"><i
                                                                class="fldemo glyphicon glyphicon-remove"></i>
                                                            Remove</button>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-primary"
                                            onclick="return confirm('Apakah data sudah benar?');">Submit</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.remove-exists', function() {
